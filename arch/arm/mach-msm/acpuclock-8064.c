...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[5]  = { {  648000, HFPLL, 1, 0x18 }, 1050000, 1050000, 3 },
	[6]  = { {  702000, HFPLL, 1, 0x1A }, 1150000, 1150000, 3 },
	[7]  = { {  756000, HFPLL, 1, 0x1C }, 1150000, 1150000, 3 },
...
static struct acpu_level tbl_slow[] __initdata = {
	{ 1, {   192000, HFPLL, 1, 0x08 }, L2(0),   925000 },
...
static struct acpu_level tbl_nom[] __initdata = {
	...
	{ 0, {  1080000, HFPLL, 1, 0x28 }, L2(10), 1125000 },
	{ 0, {  1134000, HFPLL, 1, 0x2A }, L2(10), 1125000 },
	{ 0, {  1188000, HFPLL, 1, 0x2C }, L2(10), 1150000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(10), 1150000 },
	{ 0, {  1296000, HFPLL, 1, 0x30 }, L2(14), 1175000 },
	{ 0, {  1350000, HFPLL, 1, 0x32 }, L2(14), 1175000 },
	{ 0, {  1404000, HFPLL, 1, 0x34 }, L2(14), 1187500 },
	{ 0, {  1458000, HFPLL, 1, 0x36 }, L2(14), 1187500 },
	{ 1, {  1512000, HFPLL, 1, 0x38 }, L2(14), 1200000 },
	{ 0, { 0 } }
};

static struct acpu_level tbl_fast[] __initdata = {
	{ 1, {   192000, HFPLL, 1, 0x08 }, L2(0),   825000 },
	...
	{ 0, {  1080000, HFPLL, 1, 0x28 }, L2(10), 1075000 },
	{ 0, {  1134000, HFPLL, 1, 0x2A }, L2(10), 1075000 },
	{ 0, {  1188000, HFPLL, 1, 0x2C }, L2(10), 1100000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(10), 1100000 },
	{ 0, {  1296000, HFPLL, 1, 0x30 }, L2(14), 1125000 },
	{ 0, {  1350000, HFPLL, 1, 0x32 }, L2(14), 1125000 },
	{ 0, {  1404000, HFPLL, 1, 0x34 }, L2(14), 1137500 },
	{ 0, {  1458000, HFPLL, 1, 0x36 }, L2(14), 1137500 },
...
static struct acpu_level tbl_PVS4_1512MHz[] __initdata = {
	{ 1, {   192000, HFPLL, 1, 0x08 }, L2(0),   850000 },
...
static struct acpu_level tbl_PVS0_1700MHz[] __initdata = {
	{ 1, {   192000, HFPLL, 1, 0x08 }, L2(0),   950000 },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   950000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),   950000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   950000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),   962500 },
...
static struct acpu_level tbl_PVS2_1700MHz[] __initdata = {
	{ 1, {   192000, HFPLL, 1, 0x08 }, L2(0),   900000 },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   925000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),   925000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   925000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),   925000 },
